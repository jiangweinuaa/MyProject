...
/**
 * 分销系统OMS用，获取OMS系统电商退货单，上次获取结束时间(到秒)保存在redis中
 *
 ...
 *
 *
 * 增加：转退销售单失败的OMS退货单号保存到Hash缓存中，定时处理失败单据
 *
...
public class OMSReturnOrder extends InitJob
{
    ...
    public OMSReturnOrder()
    {

    }

    public OMSReturnOrder(String eId,String shopId,String organizationNO, String billNo)
    {
        pEId=eId;
        pShop=shopId;
    ...
    public String doExe()  throws Exception
    {
        ...
        if (bRun && pEId.equals(""))
        {
            logger.info("\r\n*********获取分销OMS系统电商退货单OMSReturnOrder正在执行中,本次调用取消:************\r\n");

            sReturnInfo="定时传输任务-获取分销OMS系统电商退货单OMSReturnOrder正在执行中！";
            return sReturnInfo;
        }
        ...
        {
            sReturnInfo="定时传输任务-获取分销OMS系统电商退货单OMSReturnOrder配置文件参数OMS_Url或OMS_Eid或OMS_ERP_Eid不能为空！";
            logger.error("\r\n*********"+sReturnInfo+"************\r\n");
            return sReturnInfo;
        }
        ...
        logger.info("\r\n*********获取分销OMS系统电商退货单OMSReturnOrder定时调用Start:************\r\n");

        RedisPosPub redis=new RedisPosPub();
        JSONObject jsonRedis=new JSONObject();
        try
        {
            String values=redis.getString("OMS_ReturnOrder");
            String startTime="";
            ...
            logger.info("\r\n*********获取分销OMS系统电商退货单OMSReturnOrder定时调用请求:"+head.toString()+"************\r\n");
            ...
            {
                logger.error("\r\n*********获取分销OMS系统电商退货单OMSReturnOrder 请求分销系统报错，返回为空************\r\n");
            }
            else
            {
...
//                                    }
                                    ...
                                    String b_unit=ebb_list.getJSONObject(i1).get("ecbtunit").toString();//交易单位
                                ...
                                if (eaiList != null && eaiList.length()>0)
                                {
                                    ...
                                    logger.info("\r\n*********获取分销OMS系统电商退货单OMSReturnOrder定时调用请求:"+eai_head.toString()+"************\r\n");
                                    ...
                                    {
                                        logger.error("\r\n*********获取分销OMS系统电商退货单OMSReturnOrder "+a_billno+"过账操作请求分销系统报错，返回为空************\r\n");
                                        billToSale_ok=false;
                                        error="*********获取分销OMS系统电商退货单OMSReturnOrder "+a_billno+"过账操作请求分销系统报错，返回为空************";
                                        continue;
                                    }
                                    else
                                    {
                                        ...
                                        if (eai_resStatus.equals("200"))
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                logger.error("\r\n*********获取分销OMS系统电商退货单OMSReturnOrder "+a_billno+"过账操作请求分销系统报错，返回内容:"+Message+"************\r\n");
                                                billToSale_ok=false;
                                                error="*********获取分销OMS系统电商退货单OMSReturnOrder "+a_billno+"过账操作请求分销系统报错，返回内容:"+Message+"************";
                                                continue;
                                            }
                                        }
                                        else
                                        {
                                            logger.error("\r\n*********获取分销OMS系统电商退货单OMSReturnOrder "+a_billno+"过账操作请求分销系统报错，返回内容:"+resBody+"************\r\n");
                                            billToSale_ok=false;
                                            error="*********获取分销OMS系统电商退货单OMSReturnOrder "+a_billno+"过账操作请求分销系统报错************";
                                            continue;
                                        }
                                    }
                                }
                            ...
                            catch (Exception e)
                            {
                                ...
                                try
                                {
                                    ...
                                    logger.error("\r\n******获取分销OMS系统电商退货单OMSReturnOrder报错单号:"+a_billno + e.getMessage()+"\r\n" + errors.toString() + "******\r\n");
                                    ...
                                    error="******获取分销OMS系统电商退货单OMSReturnOrder报错单号:"+a_billno + e.getMessage()+" " + sb_errors + "******";
                                ...
                                catch (IOException e1)
                                {
                                    ...
                                    error="******获取分销OMS系统电商退货单OMSReturnOrder报错单号:"+a_billno + e.getMessage() + "******";
                                }
                            }
                            finally
                            {
                                ...
                                if (!billToSale_ok)
                                {
                                    ...
                                    redis.setHashMap("OMS_ReturnOrder_Exception",oms_eid+"_"+a_billno,jsonExceptionRedis.toString());
                                }
                            }
                        }
                        //处理成功更新缓存
                        ...
                        redis.setString("OMS_ReturnOrder",jsonRedis.toString());
                    }
                    else
                    {
                        String Message="";
                        ...
                        logger.error("\r\n*********获取分销OMS系统电商退货单OMSReturnOrder 请求分销系统报错，返回为"+Message+"************\r\n");
                    }
                }
                else
                {
                    logger.error("\r\n*********获取分销OMS系统电商退货单OMSReturnOrder 请求分销系统报错，返回为空"+resBody+"************\r\n");
                }
            }
        }
        catch (Exception e)
        {
            try
            {
                ...
                logger.error("\r\n******获取分销OMS系统电商退货单OMSReturnOrder报错信息" + e.getMessage()+"\r\n" + errors.toString() + "******\r\n");
        ...
        {
            bRun=false;//
            logger.info("\r\n*********获取分销OMS系统电商退货单OMSReturnOrder定时调用End:************\r\n");
        }
