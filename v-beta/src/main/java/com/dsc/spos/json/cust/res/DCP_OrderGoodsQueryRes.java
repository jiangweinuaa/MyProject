...
public class DCP_OrderGoodsQueryRes extends JsonRes 
{
	...
	public class level1Elm
	{
		...
		private List<level2Spec> specDatas;
		private List<level2Attr> attrDatas;
		...
		public List<level2Spec> getSpecDatas() {
			return specDatas;
		}
		public void setSpecDatas(List<level2Spec> specDatas) {
			this.specDatas = specDatas;
		}
		public List<level2Attr> getAttrDatas() {
			return attrDatas;
		}
		public void setAttrDatas(List<level2Attr> attrDatas) {
