...
@Getter
@Setter
public class DCP_PriceAdjustUpdateReq extends JsonBasicReq {
    ...
    public class Request {
        ...
        @JSONFieldRequired(display = "单据日期，格式YYYY-MM-DD")
        private String bdate;
        private String isUpdateSdPrice;
        private String memo;
        @JSONFieldRequired(display = "调价人员")
        private String employeeID;
//        @JSONFieldRequired(display = "价格失效日")
        ...
        @JSONFieldRequired(display = "调价单号")
        private String billNo;
        @JSONFieldRequired(display = "价格生效日，格式YYYY-MM-DD")
    ...
    public class PluList {
        @JSONFieldRequired(display = "计价单位：采购单位/销售单位")
