...
@Data
public class DCP_VendorAdjUpdateReq extends JsonBasicReq {
    @JSONFieldRequired
    private DCP_VendorAdjUpdateReq.levelElm request;
    ...
    public class levelElm{
        ...
        @JSONFieldRequired
        private List<DCP_VendorAdjUpdateReq.AdjList> adjList;
    }
