...
public class DCP_LStockOutRefundCreateReq extends JsonBasicReq
{
    ...
    public class levelElm{
        ...
        private String lStockoutNo_origin;//来源单号
        ...
        public String getlStockoutNo_origin()
        {
            return lStockoutNo_origin;
        }

        public void setlStockoutNo_origin(String lStockoutNo_origin)
        {
            this.lStockoutNo_origin = lStockoutNo_origin;
        }
    ...
    public class level1Elm {
        ...
        private String item_origin;//来源项次
        private String pqty_origin;//来源数量
