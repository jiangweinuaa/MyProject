...
@Data
public class DCP_ApWrtOffUpdateReq extends JsonBasicReq {

    private DCP_ApWrtOffUpdateReq.RequestLevel request;
    ...
    public  class RequestLevel {
        ...
        private String glNo;
        private List<DCP_ApWrtOffUpdateReq.ApWFListLevel> apWFList;
        private List<DCP_ApWrtOffUpdateReq.PmtListLevel> pmtList;
