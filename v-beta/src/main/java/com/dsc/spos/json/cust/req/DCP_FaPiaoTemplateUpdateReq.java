...
@NoArgsConstructor
@AllArgsConstructor
public class DCP_FaPiaoTemplateUpdateReq extends JsonBasicReq {
    ...
    public static class level1Elm {
        private String templateId; // 模板编码，不可修改
        private String templateName; // 模板名称
        private String platformType; // 发票平台，不可修改
        private String templateType; // 模板类型1-通用2-专用
        private List<level2Elm> shopList; // 指定门店时不可空
