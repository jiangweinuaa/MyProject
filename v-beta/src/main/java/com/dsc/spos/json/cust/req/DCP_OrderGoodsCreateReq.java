...
public class DCP_OrderGoodsCreateReq extends JsonBasicReq 
{
	...
	private List<level1Spec> specDatas;
	private List<level1Attr> attrDatas;
	...
	public List<level1Spec> getSpecDatas() {
		return specDatas;
	}
	public void setSpecDatas(List<level1Spec> specDatas) {
		this.specDatas = specDatas;
	}
	public List<level1Attr> getAttrDatas() {
		return attrDatas;
	}
	public void setAttrDatas(List<level1Attr> attrDatas) {
