...
import com.dsc.spos.json.cust.req.DCP_PurStockOutUpdateReq;
import com.dsc.spos.json.cust.res.DCP_PurStockOutUpdateRes;
...
public class DCP_PurStockOutUpdate extends SPosAdvanceService<DCP_PurStockOutUpdateReq, DCP_PurStockOutUpdateRes> {
    @Override
    protected void processDUID(DCP_PurStockOutUpdateReq req, DCP_PurStockOutUpdateRes res) throws Exception {

        String orderNo = req.getRequest().getPStockOutNo();
        ...
        //删除所有单身
        DelBean db1 = new DelBean("DCP_PURSTOCKIN_DETAIL");
        db1.addCondition("PSTOCKINNO", new DataValue(orderNo, Types.VARCHAR));
        db1.addCondition("EID", new DataValue(eId, Types.VARCHAR));
        db1.addCondition("ORGANIZATIONNO", new DataValue(organizationNO, Types.VARCHAR));
        this.addProcessData(new DataProcessBean(db1));

        DelBean db2 = new DelBean("DCP_PURSTOCKIN_LOTS");
        db2.addCondition("PSTOCKINNO", new DataValue(orderNo, Types.VARCHAR));
        db2.addCondition("EID", new DataValue(eId, Types.VARCHAR));
        db2.addCondition("ORGANIZATIONNO", new DataValue(organizationNO, Types.VARCHAR));
        this.addProcessData(new DataProcessBean(db2));

        DCP_PurStockOutUpdateReq.Request request = req.getRequest();
        ...
        List<DCP_PurStockOutUpdateReq.Detail> dataList = request.getDataList();
        ...
        for (DCP_PurStockOutUpdateReq.Detail detail : dataList){
            item++;
            String wunit="";
            String baseUnit="";
            String location="";
            ...
            List<DCP_PurStockOutUpdateReq.MulitiLosts> mulitiLotsList = detail.getMulitiLotsList();
            if(mulitiLotsList != null&& mulitiLotsList.size()>0){
                ...
                int mulItem=0;
                for (DCP_PurStockOutUpdateReq.MulitiLosts mulitiLots : mulitiLotsList){
                    mulItem++;
        ...
        UptBean ub1 = new UptBean("DCP_PURSTOCKIN");
        //add Value
        ub1.addUpdateValue("BDATE", new DataValue(request.getBDate(), Types.DATE));
        ub1.addUpdateValue("ACCOUNT_DATE", new DataValue(request.getAccountDate(), Types.DATE));
        ub1.addUpdateValue("BILLTYPE", new DataValue(request.getBillType(), Types.VARCHAR));
        ub1.addUpdateValue("RECEIVINGNO", new DataValue(request.getReceivingNo(), Types.VARCHAR));
        ...
        ub1.addUpdateValue("SUPPLIER", new DataValue(request.getSupplierNo(), Types.VARCHAR));
        ...
        ub1.addUpdateValue("PURORGNO", new DataValue(request.getPurOrgNo(), Types.VARCHAR));
        ub1.addUpdateValue("TOT_CQTY", new DataValue(totCqty.toString(), Types.VARCHAR));
        ub1.addUpdateValue("TOT_PQTY", new DataValue(totPqty.toString(), Types.VARCHAR));
        ub1.addUpdateValue("TOT_PURAMT", new DataValue(totPurAmt.toString(), Types.VARCHAR));
        ub1.addUpdateValue("TOT_PRETAXAMT", new DataValue(totPreTaxAmt.toString(), Types.VARCHAR));
        ub1.addUpdateValue("TOT_TAXAMT", new DataValue(totTaxAmt.toString(), Types.VARCHAR));
        ...
        ub1.addUpdateValue("INVOICECODE", new DataValue(request.getInvoiceCode(), Types.DATE));
        ub1.addUpdateValue("CURRENCY", new DataValue(request.getCurrency(), Types.VARCHAR));
        //ub1.addUpdateValue("DELIVERYFEE", new DataValue(request.getde(), Types.VARCHAR));
        ub1.addUpdateValue("MEMO", new DataValue(request.getMemo(), Types.DECIMAL));
        ...
        ub1.addCondition("PSTOCKINNO", new DataValue(orderNo, Types.VARCHAR));
    ...
    @Override
    protected List<InsBean> prepareInsertData(DCP_PurStockOutUpdateReq req) throws Exception {
        return null;
    }

    @Override
    protected List<UptBean> prepareUpdateData(DCP_PurStockOutUpdateReq req) throws Exception {
        return null;
    }

    @Override
    protected List<DelBean> prepareDeleteData(DCP_PurStockOutUpdateReq req) throws Exception {
        return null;
    }

    @Override
    protected boolean isVerifyFail(DCP_PurStockOutUpdateReq req) throws Exception {
        return false;
    }

    @Override
    protected TypeToken<DCP_PurStockOutUpdateReq> getRequestType() {
        return new TypeToken<DCP_PurStockOutUpdateReq>() {

        };
    }

    @Override
    protected DCP_PurStockOutUpdateRes getResponseType() {
        return new DCP_PurStockOutUpdateRes();
    }

    @Override
    protected String getQuerySql(DCP_PurStockOutUpdateReq req) throws Exception {
        return null;
    }
}
