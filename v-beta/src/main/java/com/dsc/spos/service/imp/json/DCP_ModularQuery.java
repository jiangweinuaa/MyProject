...
import com.dingtalk.api.request.OapiCallbackFailrecordListRequest.Req;
import com.dsc.spos.json.cust.req.DCP_ModularQueryReq;
import com.dsc.spos.json.cust.req.DCP_ModularQueryReq.level1Elm;
import com.dsc.spos.json.cust.res.DCP_ModularQueryRes;
import com.dsc.spos.service.SPosBasicService;
import com.dsc.spos.utils.MapDistinct;
import com.google.gson.reflect.TypeToken;

public class DCP_ModularQuery extends SPosBasicService<DCP_ModularQueryReq, DCP_ModularQueryRes> {

	@Override
	protected boolean isVerifyFail(DCP_ModularQueryReq req) throws Exception {
		// TODO Auto-generated method stub
		return false;
	}

	@Override
	protected TypeToken<DCP_ModularQueryReq> getRequestType() {
		// TODO Auto-generated method stub
		return new TypeToken<DCP_ModularQueryReq>() {
		};
	}

	@Override
	protected DCP_ModularQueryRes getResponseType() {
		// TODO Auto-generated method stub
		return new DCP_ModularQueryRes();
	}

	List<Map<String, Object>> allFuncDatas = new ArrayList<Map<String, Object>>();

	@Override
	protected DCP_ModularQueryRes processJson(DCP_ModularQueryReq req) throws Exception {
		// TODO Auto-generated method stub

		String sql = null;
		// 查詢資料
		DCP_ModularQueryRes res = null;
		...
		if (getFstData != null && getFstData.isEmpty() == false) {
			...
			res.setMemuDatas(new ArrayList<DCP_ModularQueryRes.level1Elm>());
			for (Map<String, Object> fstMenuData : getFstMenuDatas) {
				...
				if (fModularLevel != null && fModularLevel.equals("1")) {
					...
					DCP_ModularQueryRes.level1Elm oneLv1 = res.new level1Elm();

					oneLv1.setChildren(new ArrayList<DCP_ModularQueryRes.level1Elm>());
					oneLv1.setFunction(new ArrayList<DCP_ModularQueryRes.function>());
					// 设置响应
					...
					for (Map<String, Object> fstFuncDatas : getFstMenuDatas) {
						...
						if (fModularNO.equals(fstFuncDatas.get("FMODULARNO")) == false)
							continue;
						// 在这里过滤除属于第一级的func
						DCP_ModularQueryRes.function fstFunc = res.new function();
	...
	@Override
	protected String getQuerySql(DCP_ModularQueryReq req) throws Exception {
		// TODO Auto-generated method stub
		String sql = null;
	...
	// 这里写一个递归的调用当前的方法
	protected void setChildrenDatas(DCP_ModularQueryRes.level1Elm oneLv2, List<Map<String, Object>> allMenuDatas)
			throws Exception {
		...
		try {
			...
			if (upModularList2 != null && !upModularList2.isEmpty()) {
				for (Map<String, Object> menuDatas : upModularList2) {
					DCP_ModularQueryRes.level1Elm lv1 = new DCP_ModularQueryRes(). new level1Elm();
					lv1.setChildren(new ArrayList<DCP_ModularQueryRes.level1Elm>());
					lv1.setFunction(new ArrayList<DCP_ModularQueryRes.function>());
					...
					for (Map<String, Object> fstFuncDatas : upModularList) {
						...
						DCP_ModularQueryRes.function fstFunc = new DCP_ModularQueryRes(). new function();
