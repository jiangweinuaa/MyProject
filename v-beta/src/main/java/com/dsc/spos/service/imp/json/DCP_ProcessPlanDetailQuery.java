...
import com.dsc.spos.json.cust.req.DCP_ProcessPlanDetailQueryReq;
import com.dsc.spos.json.cust.res.DCP_ProcessPlanDetailQueryRes;
...
public class DCP_ProcessPlanDetailQuery extends SPosBasicService<DCP_ProcessPlanDetailQueryReq, DCP_ProcessPlanDetailQueryRes>
{


    @Override
    protected boolean isVerifyFail(DCP_ProcessPlanDetailQueryReq req) throws Exception
    {
    ...
    @Override
    protected TypeToken<DCP_ProcessPlanDetailQueryReq> getRequestType()
    {
        return new TypeToken<DCP_ProcessPlanDetailQueryReq>(){};
    }

    @Override
    protected DCP_ProcessPlanDetailQueryRes getResponseType()
    {
        return new DCP_ProcessPlanDetailQueryRes();
    }

    @Override
    protected DCP_ProcessPlanDetailQueryRes processJson(DCP_ProcessPlanDetailQueryReq req) throws Exception
    {
        DCP_ProcessPlanDetailQueryRes res=this.getResponseType();
        ...
        if (getQData != null && !getQData.isEmpty())
        {
            ...
            {
                DCP_ProcessPlanDetailQueryRes.level2Elm lv2=res.new level2Elm();
                ...
                lv2.setAdviceQty(map.get("ADVICEQTY").toString());
    ...
    @Override
    protected String getQuerySql(DCP_ProcessPlanDetailQueryReq req) throws Exception
    {
