...
public class DCP_OrderTransTaskGoodsRes extends JsonRes{
	...
	public class level1Elm
	{
		...
		public List<level2Attr> getAttr() {
			return attr;
		}
		public void setAttr(List<level2Attr> attr) {
			this.attr = attr;
		}
		...
		public String getElmHash() {
			return elmHash;
		}
		public void setElmHash(String elmHash) {
			this.elmHash = elmHash;
		}
			
		public String getJbpHash() {
		return jbpHash;
		}
		public void setJbpHash(String jbpHash) {
			this.jbpHash = jbpHash;
		}
	...
	public class level2Spec
	{
		...
		private String stockQty;//当前库存量
		private String maxStockQty;//最大库存量
		private String packageFee;//包装费
		private String isOnShelf;//是否上架
	...
	public class level2Attr
	{
		...
		public String getOrderAttrName() {
			return orderAttrName;
		}
		public void setOrderAttrName(String orderAttrName) {
