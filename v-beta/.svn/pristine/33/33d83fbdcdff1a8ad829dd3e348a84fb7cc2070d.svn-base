...
import com.dsc.spos.json.cust.req.DCP_StockOrderLockDetail_OpenReq.OrganizationList;
import com.dsc.spos.json.cust.res.DCP_StockOrderLockDetail_OpenRes;
import com.dsc.spos.json.cust.res.DCP_StockOrderLockDetail_OpenRes.levelRes;
 ...
 *
 */
public class DCP_StockOrderLockDetail_Open extends SPosBasicService<DCP_StockOrderLockDetail_OpenReq, DCP_StockOrderLockDetail_OpenRes> {

	@Override
	protected boolean isVerifyFail(DCP_StockOrderLockDetail_OpenReq req) throws Exception {
		// TODO Auto-generated method stub
		return false;
	}

	@Override
	protected TypeToken<DCP_StockOrderLockDetail_OpenReq> getRequestType() {
		// TODO Auto-generated method stub
		return new TypeToken<DCP_StockOrderLockDetail_OpenReq>(){};
	}

	@Override
	protected DCP_StockOrderLockDetail_OpenRes getResponseType() {
		// TODO Auto-generated method stub
		return new DCP_StockOrderLockDetail_OpenRes();
	}

	@Override
	protected DCP_StockOrderLockDetail_OpenRes processJson(DCP_StockOrderLockDetail_OpenReq req) throws Exception {
		// TODO Auto-generated method stub

		DCP_StockOrderLockDetail_OpenRes res = null;
		...
		try {
			...
			lvRes.setBillList(new ArrayList<DCP_StockOrderLockDetail_OpenRes.BillList>());
			...
			if(queryDatas.size() > 0 && !queryDatas.isEmpty()){
				...
				for (Map<String, Object> map : queryDatas) {
					DCP_StockOrderLockDetail_OpenRes.BillList lvPlu = res.new BillList();
...
//					lvPlu.setLockDate(lockDate);
	...
	@Override
	protected String getQuerySql(DCP_StockOrderLockDetail_OpenReq req) throws Exception {
		// TODO Auto-generated method stub
		String sql = null;
