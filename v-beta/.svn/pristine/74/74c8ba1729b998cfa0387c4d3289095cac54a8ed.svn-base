...
public class RuiXiangReturnOrderUpLoad extends InitJob
{
    ...
    Logger logger = LogManager.getLogger(RuiXiangReturnOrderUpLoad.class.getName());

    static boolean bRun=false;//标记此服务是否正在执行中


    public  RuiXiangReturnOrderUpLoad()
    {

    }

    public  RuiXiangReturnOrderUpLoad(String eId,String shopId,String organizationNO, String billNo)
    {
        pEId=eId;
        pShop=shopId;
    ...
    public String doExe()  throws Exception
    {
        ...
        if (bRun && pEId.equals(""))
        {
            logger.info("\r\n*********退收货单上传锐翔系统RuiXiangReturnOrderUpLoad正在执行中,本次调用取消:************\r\n");

            sReturnInfo="定时传输任务-退收货单上传锐翔系统RuiXiangReturnOrderUpLoad正在执行中！";
            return sReturnInfo;
        }
        ...
        {
            sReturnInfo="定时传输任务-退收货单上传锐翔系统RuiXiangReturnOrderUpLoad配置文件参数RuiXiang_Url、RuiXiang_Secret、ruiXiang_appid、ruiXiang_eid不能为空！";
            logger.error("\r\n*********"+sReturnInfo+"************\r\n");
            return sReturnInfo;
        }
        ...
        logger.info("\r\n*********退收货单上传锐翔系统RuiXiangReturnOrderUpLoad定时调用Start:************\r\n");
        ...
        try
        {
            ...
            logger.info("\r\n******退收货单RuiXiangReturnOrderUpLoad SQL=" + sql + "******\r\n");
                ...
                for (Map<String, Object> oneData100 : getQData100_02)
                {
                    try
                    {
                        ...
                        if (getQData100_02 != null && getQData100_02.isEmpty() == false)
                        {
                            ...
                            maininfo.put("yrnumber", Check.Null(loadDocNo)?stockOutNO100:loadDocNo);//来源单号
                            ...
                            logger.info("\r\n******退收货单RuiXiangReturnOrderUpLoad请求锐翔系统传入参数：  " + head.toString() +"地址："+v_RuiXiang_Url+ "\r\n");
                            ...
                            try
                            {
                                ...
                                logger.info("\r\n******退收货单RuiXiangReturnOrderUpLoad请求锐翔系统返回参数：  "+ "\r\n单号="+ stockOutNO100 + "\r\n" + resBody + "******\r\n");
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        InsertWSLOG.insert_WSLOG("RuiXiangReturnOrderUpLoad",stockOutNO100,eId,organizationNO,"1",str,resBody,resCode,description) ;
                                    }
                                }
                            ...
                            catch (Exception e)
                            {
                                ...
                                InsertWSLOG.insert_WSLOG("RuiXiangReturnOrderUpLoad",stockOutNO100,eId,shopId,"1",str,resBody,"-1",e.getMessage());

                                sReturnInfo="错误信息:" + e.getMessage();

                                logger.error("\r\n******退收货单RuiXiangReturnOrderUpLoad：门店=" +shopId+",组织编码=" + organizationNO + ",公司编码=" +eId +",单号="  +stockOutNO100 + "\r\n报错信息："+e.getMessage()+"******\r\n");
                            }
                        }
                        else
                        {
                            ...
                            logger.info("\r\n******退收货单RuiXiangReturnOrderUpLoad：门店=" +shopId+",组织编码=" + organizationNO + ",公司编码=" +eId +",单号="  +stockOutNO100 + "无单身数据！******\r\n");
                        }
                    ...
                    catch (Exception e1)
                    {
                        try
                        {
                            ...
                            logger.error("\r\n******退收货单RuiXiangReturnOrderUpLoad报错信息" + e1.getMessage()+"\r\n" + errors.toString() + "******\r\n");
                        ...
                        {
                            logger.error("\r\n******退收货单RuiXiangReturnOrderUpLoad报错信息" + e2.getMessage() + "******\r\n");
                        }
            ...
            else
            {
                ...
                logger.info("\r\n******退收货单RuiXiangReturnOrderUpLoad没有要上传的单头数据******\r\n");
            }
        }
        catch (Exception e)
        {
            try
            {
                ...
                logger.error("\r\n******退收货单上传锐翔系统RuiXiangReturnOrderUpLoad报错信息" + e.getMessage()+"\r\n" + errors.toString() + "******\r\n");
        ...
        {
            bRun=false;//
            logger.info("\r\n*********退收货单上传锐翔系统RuiXiangReturnOrderUpLoad定时调用End:************\r\n");
        }
    ...
    protected String getQuerySql100_02() throws Exception
    {
        ...
        sqlbuf.append(""
                              ...
                              + " CANCELBY,CANCELDATE,CANCELTIME,TRANSFERSHOP,TOTPQTY,TOTAMT,TOTCQTY,MODIFYBY,MODIFYDATE,MODIFYTIME,BSNO,receiptorg, belfirm,OUT_COST_WAREHOUSE "
                              + " from ("
                              ...
                              + " a.MODIFYBY,a.MODIFY_DATE as MODIFYDATE,a.MODIFY_TIME as MODIFYTIME, a.BSNO , a.receipt_org as receiptorg, b.belfirm,b.OUT_COST_WAREHOUSE "
                              + " FROM DCP_STOCKOUT a "
                              + " LEFT JOIN DCP_ORG b ON a.EID = b.EID AND a.SHOPID = b.organizationno AND b.STATUS = '100' "
                              + " WHERE (a.status = '2') AND a.process_status = 'N' and a.DOC_TYPE='0' "
        );
    ...
    protected String getQuerySql101_02(String eId, String organizationNO, String stockOutNO100) throws Exception
    {
        ...
        sqlbuf.append("select item,oItem,pluNO ,GOODSMEMO,baseunit, punit,pqty,baseqty, "
                              + " unitRatio ,price,amt,pluBarcode,warehouse,BATCH_NO,PROD_DATE,DISTRIPRICE,DISTRIAMT,featureno,MEMO  from ("
                              + " SELECT  a.ITEM,a.OITEM,a.PLUNO ,b.memo GOODSMEMO,a.baseunit, a.PUNIT,a.PQTY,a.baseqty, "
                              + " a.UNIT_RATIO AS UNITRATIO ,a.PRICE,a.AMT,a.PLU_BARCODE as pluBarcode,a.warehouse,"
                              + " a.BATCH_NO,a.PROD_DATE,a.DISTRIPRICE,a.DISTRIAMT,a.featureno ,a.PLU_MEMO MEMO "
                              + " FROM DCP_STOCKOUT_DETAIL a "
                              + " inner join dcp_goods b on a.eid=b.eid and a.pluno=b.pluno "
                              + " WHERE a.EID = '"+eId+"'  " + " AND a.ORGANIZATIONNO = '"+organizationNO+"'  " + " AND a.STOCKOUTNO = '"+stockOutNO100+"' ");
        sqlbuf.append(" ) TBL ");
