...
import com.dsc.spos.json.cust.req.DCP_MultiSpecGoodsUpdateReq;
import com.dsc.spos.json.cust.req.DCP_MultiSpecGoodsUpdateReq.attr;
import com.dsc.spos.json.cust.req.DCP_MultiSpecGoodsUpdateReq.attrValue;
import com.dsc.spos.json.cust.req.DCP_MultiSpecGoodsUpdateReq.masterPluName_lang;
import com.dsc.spos.json.cust.req.DCP_MultiSpecGoodsUpdateReq.subGoods;
import com.dsc.spos.json.cust.res.DCP_MultiSpecGoodsUpdateRes;
...
public class DCP_MultiSpecGoodsUpdate  extends SPosAdvanceService<DCP_MultiSpecGoodsUpdateReq,DCP_MultiSpecGoodsUpdateRes>{

	@Override
	protected void processDUID(DCP_MultiSpecGoodsUpdateReq req, DCP_MultiSpecGoodsUpdateRes res) throws Exception
	{
		...
		DelBean db6 = new DelBean("DCP_MSPECGOODS_SUBGOODS_LANG");
		db6.addCondition("MASTERPLUNO", new DataValue(masterPluNo, Types.VARCHAR));
		db6.addCondition("EID", new DataValue(eId, Types.VARCHAR));
		this.addProcessData(new DataProcessBean(db6)); //不能刪，因为前端没有传所有语言 
...
//			UptBean ub_lang = new UptBean("DCP_MSPECGOODS_SUBGOODS_LANG");			
//			ub_lang.addCondition("EID",new DataValue(req.geteId(), Types.VARCHAR));
//			ub_lang.addCondition("MASTERPLUNO", new DataValue(masterPluNo, Types.VARCHAR));
//			ub_lang.addCondition("FEATURENO", new DataValue(par.getFeatureNo(), Types.VARCHAR));
//			ub_lang.addCondition("LANG_TYPE", new DataValue(curLangType, Types.VARCHAR));
//
//
//			ub_lang.addUpdateValue("FEATURENAME",new DataValue(par.getFeatureName(), Types.VARCHAR)); 				
//			ub_lang.addUpdateValue("LASTMODITIME",new DataValue(lastmoditime, Types.DATE)); 
//
//			this.addProcessData(new DataProcessBean(ub_lang));


		}

		UptBean ub1 = new UptBean("DCP_MSPECGOODS");
		ub1.addCondition("EID",new DataValue(req.geteId(), Types.VARCHAR));
		ub1.addCondition("MASTERPLUNO", new DataValue(masterPluNo, Types.VARCHAR));
		...
		ub1.addUpdateValue("MINPRICE",new DataValue(minPrice.toPlainString(), Types.VARCHAR));
		ub1.addUpdateValue("MAXPRICE",new DataValue(maxPrice.toPlainString(), Types.VARCHAR));
	...
	@Override
	protected List<InsBean> prepareInsertData(DCP_MultiSpecGoodsUpdateReq req) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	protected List<UptBean> prepareUpdateData(DCP_MultiSpecGoodsUpdateReq req) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	protected List<DelBean> prepareDeleteData(DCP_MultiSpecGoodsUpdateReq req) throws Exception {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	protected boolean isVerifyFail(DCP_MultiSpecGoodsUpdateReq req) throws Exception {
		// TODO Auto-generated method stub
	...
	@Override
	protected TypeToken<DCP_MultiSpecGoodsUpdateReq> getRequestType() {
		// TODO Auto-generated method stub
		return new TypeToken<DCP_MultiSpecGoodsUpdateReq>(){} ;
	}

	@Override
	protected DCP_MultiSpecGoodsUpdateRes getResponseType() {
		// TODO Auto-generated method stub
		return new DCP_MultiSpecGoodsUpdateRes();
	}
	...
	{
		boolean nRet = false;
		String sql =" select * from DCP_MULTISPECGOODS_LANG "
