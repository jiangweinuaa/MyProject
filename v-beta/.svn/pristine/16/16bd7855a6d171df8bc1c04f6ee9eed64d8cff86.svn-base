 ...
 * @since  2017-03-31
 */
public class DCP_PStockInRefundCreateReq extends JsonBasicReq{
	...
	public  class level2Elm{
        ...
        public List<DCP_PStockInRefundCreateReq.materialBatchList> getMaterialBatchList() {
            return materialBatchList;
        }

        public void setMaterialBatchList(List<DCP_PStockInRefundCreateReq.materialBatchList> materialBatchList) {
