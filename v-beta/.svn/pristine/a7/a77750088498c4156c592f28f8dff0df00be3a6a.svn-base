...
@Getter
@Setter
public class DCP_CustomerPOrderCreateReq extends JsonBasicReq {
    ...
    public class Request {
        ...
        @JSONFieldRequired(display = "业务部门")
    ...
    public class Datas {
        ...
        @JSONFieldRequired(display = "交易金额")
        private String amt;
        ...
        @JSONFieldRequired(display = "是否为赠品 0否1是")
        private String isGift;
        @JSONFieldRequired(display = "标准价")
        private String oPrice;
        private String taxAmt;
//        @JSONFieldRequired(display = "计税方式1一般 2运费/农产品")
        private String taxCalType;
        @JSONFieldRequired(display = "零售金额")
        private String retailAmt;
//        @JSONFieldRequired(display = "税别编码")
        private String taxCode;
        @JSONFieldRequired(display = "折扣金额：（标准价-交易价）*交易数量")
