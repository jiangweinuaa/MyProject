...
import com.dsc.spos.json.cust.req.DCP_BsNoSetSubjectQueryReq;
import com.dsc.spos.json.cust.res.DCP_BsNoSetSubjectQueryRes;
...
public class DCP_BsNoSetSubjectQuery extends SPosBasicService<DCP_BsNoSetSubjectQueryReq, DCP_BsNoSetSubjectQueryRes> {

    @Override
    protected boolean isVerifyFail(DCP_BsNoSetSubjectQueryReq req) throws Exception {
    ...
    @Override
    protected TypeToken<DCP_BsNoSetSubjectQueryReq> getRequestType() {
        return new TypeToken<DCP_BsNoSetSubjectQueryReq>(){};
    }

    @Override
    protected DCP_BsNoSetSubjectQueryRes getResponseType() {
        return new DCP_BsNoSetSubjectQueryRes();
    }

    @Override
    protected DCP_BsNoSetSubjectQueryRes processJson(DCP_BsNoSetSubjectQueryReq req) throws Exception {
        DCP_BsNoSetSubjectQueryRes res = this.getResponse();
        int totalRecords=0;
        int totalPages=0;
        //单头查询
        ...
        if (getQData != null && !getQData.isEmpty()) {
            ...
            for (Map<String, Object> row : getQData){
                DCP_BsNoSetSubjectQueryRes.Level1Elm level1Elm = res.new Level1Elm();
    ...
    @Override
    protected String getQuerySql(DCP_BsNoSetSubjectQueryReq req) throws Exception {
