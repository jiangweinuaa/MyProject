...
import com.dsc.spos.json.cust.req.DCP_ProcessPlanConfirmReq;
import com.dsc.spos.json.cust.res.DCP_ProcessPlanConfirmRes;
...
public class DCP_ProcessPlanConfirm extends SPosAdvanceService<DCP_ProcessPlanConfirmReq, DCP_ProcessPlanConfirmRes>
{


    @Override
    protected void processDUID(DCP_ProcessPlanConfirmReq req, DCP_ProcessPlanConfirmRes res) throws Exception
    {
        ...
        List<DCP_ProcessPlanConfirmReq.level2> dataList = req.getRequest().getDataList();

        for (DCP_ProcessPlanConfirmReq.level2 level2 : dataList)
        {
    ...
    @Override
    protected List<InsBean> prepareInsertData(DCP_ProcessPlanConfirmReq req) throws Exception
    {
        return null;
    }

    @Override
    protected List<UptBean> prepareUpdateData(DCP_ProcessPlanConfirmReq req) throws Exception
    {
        return null;
    }

    @Override
    protected List<DelBean> prepareDeleteData(DCP_ProcessPlanConfirmReq req) throws Exception
    {
        return null;
    }

    @Override
    protected boolean isVerifyFail(DCP_ProcessPlanConfirmReq req) throws Exception
    {
    ...
    @Override
    protected TypeToken<DCP_ProcessPlanConfirmReq> getRequestType()
    {
        return new TypeToken<DCP_ProcessPlanConfirmReq>(){};
    }

    @Override
    protected DCP_ProcessPlanConfirmRes getResponseType()
    {
        return new DCP_ProcessPlanConfirmRes();
    }
}
