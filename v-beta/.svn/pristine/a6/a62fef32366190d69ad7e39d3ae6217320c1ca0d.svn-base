 ...
 * @since  2020-02-16
 */
public class DCP_ECStockCreateReq extends JsonBasicReq {
	...
	public class level1Elm
	{
		...
		public String getEcStockId() {
			return ecStockId;
		}
		public void setEcStockId(String ecStockId) {
			this.ecStockId = ecStockId;
		}
