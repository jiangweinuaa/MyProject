 ...
 * 服务函数：ExternaContact
 * 服务说明：获取客户详情
 * 企微URL：https://developer.work.weixin.qq.com/document/path/96315
 * @author jinzma
 * @since  2024-01-25
 */
@Data
public class ExternaContact {
    private String errcode;
    private String errmsg;
    private External_contact external_contact;
    private List<Follow_user> follow_user;
    ...
    public class Follow_user {
        ...
        private List<Tag> tags;                    //该成员添加此外部联系人所打标签
    ...
    public class External_profile {
        ...
        private ExternaContactBatch.Wechat_channels wechat_channels;      //视频号属性。须从企业绑定到企业微信的视频号中选择，可在“我的企业”页中查看绑定的视频号。第三方仅通讯录应用可获取；对于非第三方创建的成员，第三方通讯录应用也不可获取。注意：externalcontact/get不返回该字段
    ...
    public class Tag {
        ...
        private String type;                     //该成员添加此外部联系人所打标签类型, 1-企业设置，2-用户自定义，3-规则组标签
        private String tag_id;                   //该成员添加此外部联系人所打企业标签的id，用户自定义类型标签（type=2）不返回
    }
    @Data
