 ...
 * 服务说明：N_订单参数明细 新增一个参数isDinerIn 其余代码全部继承DCP_OrderParaDetailRes
 * @author jinzma
 * @since  2024-05-23
 */
@Data
public class DCP_N_OrderParaDetailRes extends JsonRes {
    ...
    public class responseDatas {
        ...
        private String deliverShopName;    // 指定快递发货门店
