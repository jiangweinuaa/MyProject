...
public class DCP_PluGuQingConformRes extends JsonRes {
	...
	public class level1Elm{
		...
		private List<level2Elm> guQingList;
		...
		public List<level2Elm> getGuQingList() {
			return guQingList;
		}
		public void setGuQingList(List<level2Elm> guQingList) {
	...
	public class level2Elm{
		...
		private List<level3Elm> pfOrderList;
		...
		public List<level3Elm> getPfOrderList() {
			return pfOrderList;
		}
		public void setPfOrderList(List<level3Elm> pfOrderList) {
			this.pfOrderList = pfOrderList;
		}
