 ...
 *
 */
public class DCP_StockOrderLockDetail_OpenRes extends JsonRes {
...
//		private String lockDate; //锁定日期
	...
	public DCP_StockOrderLockDetail_OpenRes(com.dsc.spos.json.cust.res.DCP_StockOrderLockDetail_OpenRes.levelRes datas) {
		super();
		this.datas = datas;
	}
	
	public DCP_StockOrderLockDetail_OpenRes() {
		super();
