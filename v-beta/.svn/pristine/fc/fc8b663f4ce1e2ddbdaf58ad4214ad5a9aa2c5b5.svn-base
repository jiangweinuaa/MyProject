...
public class WMJBPShippingService extends SWaimaiBasicService {

	@Override
	public String execute(String json) throws Exception {
		// TODO Auto-generated method stub
		String res_json = HelpTools.GetJBPShippingResponse(json);
	...
	protected void processDUID(String req, Map<String, Object> res) throws Exception {
		// TODO Auto-generated method stub
		WMMTShippingService wmmtShippingService = new WMMTShippingService();
		wmmtShippingService.setDao(this.dao);
		wmmtShippingService.processDUID(req,res);
	}
