 ...
 *
 */
public class DCP_PFOrderOldUpdateReq extends JsonReq {
	...
	public class levReq{
		...
		public String getPfMatter() {
			return pfMatter;
		}
	
		public void setPfMatter(String pfMatter) {
			this.pfMatter = pfMatter;
		}
		...
		public String getPfMatterNo() {
			return pfMatterNo;
		}
	
		public void setPfMatterNo(String pfMatterNo) {
			this.pfMatterNo = pfMatterNo;
		}
	...
	public  class level1Elm{
		...
		public String getReqWQty() {
			return reqWQty;
		}
		public void setReqWQty(String reqWQty) {
			this.reqWQty = reqWQty;
		}
