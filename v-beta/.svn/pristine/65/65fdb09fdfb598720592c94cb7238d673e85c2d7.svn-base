...
@Data
public class DCP_TransApplyCreateReq  extends JsonBasicReq {

    @JSONFieldRequired
    private DCP_TransApplyCreateReq.level1Elm request;
    ...
    public class level1Elm{
        ...
        @JSONFieldRequired
        private List<DCP_TransApplyCreateReq.Detail> detail;

        private List<DCP_TransApplyCreateReq.Source> source;
