...
public class DCP_ModularUpdateReq extends JsonBasicReq 
{	
	...
	public  class level2Elm
	{
		...
		private String RFUNCNO; // 注册功能编码
		private String RPATTERN; // 功能类型1大陆 2台湾 3公用
		private String REGEDISTREX; // 加密验证REGEDISTREX （MODULARNO+RFUNCNO+"DIGIWIN" 做MD5签名） 
