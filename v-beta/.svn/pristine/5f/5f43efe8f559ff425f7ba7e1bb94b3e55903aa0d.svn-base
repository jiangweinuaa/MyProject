...
public class DCP_PGoodsRetrieveRes extends JsonRes
{
	...
	public class level1Elm
	{
		...
		private String pluName;//套餐商品名称
		private String packageShareType;//分摊方式FIXEDPRICE 固定单价 FIXEDPERCENT 固定比例 AMTPERCENT 金额比例	
	...
	public class subGoods
	{
		...
		private String detailPluName;//子商品名称
		private String detailUnit;//子商品单位
		private String detailUnitName;//子商品单位名称
		...
		public String getDetailPluName()
		{
			return detailPluName;
		}
		public void setDetailPluName(String detailPluName)
		{
			this.detailPluName = detailPluName;
		}
		public String getPrice()
		{
			return price;
