...
import com.dsc.spos.json.cust.req.DCP_NoticeCreateReq;
import com.dsc.spos.json.cust.req.DCP_NoticeCreateReq.level2Elm;
import com.dsc.spos.json.cust.res.DCP_NoticeCreateRes;
...
public class DCP_NoticeCreate extends SPosAdvanceService<DCP_NoticeCreateReq,DCP_NoticeCreateRes>
{
	@Override
	protected void processDUID(DCP_NoticeCreateReq req, DCP_NoticeCreateRes res) throws Exception 
	{	
		//新增SQL

		String[] columnsNOTICE ={"EID","NOTICE_ID","TYPE","TITLE","CONTENT","STATUS","CREATEBY","CREATE_DATE","CREATE_TIME","MODIFYBY","MODIFY_DATE","MODIFY_TIME","ISSUEBY","ISSUE_DATE","ISSUE_TIME","CANCELBY","CANCEL_DATE","CANCEL_TIME"};
		...
		String content=req.getRequest().getContent();
    ...
    SimpleDateFormat df = new SimpleDateFormat("yyyyMMdd");
		...
		insValue1 = new DataValue[] 
				{ 
						...
						new DataValue(content, Types.BLOB),
		...
		InsBean ib1 = new InsBean("DCP_NOTICE", columnsNOTICE);
	...
	@Override
	protected List<InsBean> prepareInsertData(DCP_NoticeCreateReq req) throws Exception {
	// TODO Auto-generated method stub
	return null;
	}

	@Override
	protected List<UptBean> prepareUpdateData(DCP_NoticeCreateReq req) throws Exception {
	// TODO Auto-generated method stub
	return null;
	}

	@Override
	protected List<DelBean> prepareDeleteData(DCP_NoticeCreateReq req) throws Exception {
	// TODO Auto-generated method stub
	return null;
	}

	@Override
	protected boolean isVerifyFail(DCP_NoticeCreateReq req) throws Exception 
	{	
	...
	@Override
	protected TypeToken<DCP_NoticeCreateReq> getRequestType() 
	{
	// TODO Auto-generated method stub
	return new TypeToken<DCP_NoticeCreateReq>(){};
	}

	@Override
	protected DCP_NoticeCreateRes getResponseType() {
	// TODO Auto-generated method stub
	return new DCP_NoticeCreateRes();
	}
