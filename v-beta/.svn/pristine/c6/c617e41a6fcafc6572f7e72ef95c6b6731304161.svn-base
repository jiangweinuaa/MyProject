...
@Data
public class DCP_PStockOutDetailQueryRes extends JsonRes {
    private List<DCP_PStockOutDetailQueryRes.level1Elm> datas;
    ...
    public class level1Elm {
        ...
        private List<DCP_PStockOutDetailQueryRes.level2Elm> datas;
    ...
    public class level2Elm {
        ...
        private List<DCP_PStockOutDetailQueryRes.level3Elm> material;
        private List<DCP_PStockOutDetailQueryRes.BatchList> batchList;
