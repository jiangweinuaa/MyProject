...
@Data
public class DCP_APDocUpdateReq extends JsonBasicReq {
    @JSONFieldRequired
    private DCP_APDocUpdateReq.level1Elm request;
    ...
    public class level1Elm{
        ...
        //@JSONFieldRequired
        private List<DCP_APDocUpdateReq.ApBillList> apBillList;
        //apBillSumList
        //@JSONFieldRequired
        private List<DCP_APDocUpdateReq.ApBillSumList> apBillSumList;
        //apPerdList
        //@JSONFieldRequired
        private List<DCP_APDocUpdateReq.ApPerdList> apPerdList;
        //apWFList
        //@JSONFieldRequired
        private List<DCP_APDocUpdateReq.ApWFList> apWFList;
        //pmtList
        //@JSONFieldRequired
        private List<DCP_APDocUpdateReq.PmtList> pmtList;
        //estList
        //@JSONFieldRequired
        private List<DCP_APDocUpdateReq.EstList> estList;
