 ...
 * @since  2020-07-13
 */
public class DCP_PinPeiCreateReq extends JsonBasicReq{
	...
	public class levelElm{
		...
		public String getPinPeiId() {
			return pinPeiId;
		}
		public void setPinPeiId(String pinPeiId) {
			this.pinPeiId = pinPeiId;
		}
