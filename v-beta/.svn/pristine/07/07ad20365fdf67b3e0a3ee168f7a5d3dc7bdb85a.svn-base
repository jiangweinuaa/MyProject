 ...
 *
 */
public class DCP_DeliverySettingCreateReq extends JsonBasicReq 
{
	...
	public class levelRequest
	{
        ...
        /**
         * 物品类型(顺丰同城需要，1快餐;3百货;13蛋糕；34面包糕点)(快递鸟需要，1文件；2电子产品；3蛋糕；4快餐；5鲜花绿植；13百货；99其他)
         */
		 ...
		 * 延时发物流时长(分)(小于60不起作用)
		 */
		private String delayTimeSpan = "60" ;
