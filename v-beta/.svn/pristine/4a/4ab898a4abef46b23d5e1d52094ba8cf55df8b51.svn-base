 ...
 * @since  2016-09-22
 */
public class DCP_StockOutUpdateReq extends JsonBasicReq {
	...
	public class levelElm{
        ...
        public String getIsTranInConfirm() {
            return isTranInConfirm;
        }

        public void setIsTranInConfirm(String isTranInConfirm) {
            this.isTranInConfirm = isTranInConfirm;
        }
	...
	public  class level1Elm
	{
        ...
        private List<DCP_StockOutUpdateReq.BatchList> batchList;
        private List<DCP_StockOutUpdateReq.TransInLocationList> transInLocationList;
        private String stoctOutNoQty;
        private String transferBatchNo;

        public List<level2Elm> getImageList() {
            return imageList;
        }

        public void setImageList(List<level2Elm> imageList) {
        ...
        public List<TransInLocationList> getTransInLocationList() {
            return transInLocationList;
        }

        public void setTransInLocationList(List<TransInLocationList> transInLocationList) {
            this.transInLocationList = transInLocationList;
        }

		public String getStoctOutNoQty() {
			return stoctOutNoQty;
		}

		public void setStoctOutNoQty(String stoctOutNoQty) {
			this.stoctOutNoQty = stoctOutNoQty;
		}
