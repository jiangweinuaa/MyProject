...
@Data
public class DCP_ApSetupSubjectUpdateReq extends JsonBasicReq
{

    @JSONFieldRequired
    private DCP_ApSetupSubjectUpdateReq.LevelRequest request;
    ...
    public class LevelRequest{
        ...
        private List<DCP_ApSetupSubjectUpdateReq.SetupList> setupList;
