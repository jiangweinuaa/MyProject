...
/**
 * 服務函數：POrderUpdate 說明：要库单修改 服务说明：要库单修改
 *
 * @author panjing
 * @since 2016-10-08
 * 20250217 modi by 01029 
 */
public class DCP_POrderUpdateReq extends JsonBasicReq {
	...
	public class level1Elm {
		...
		public String getPropPqty() {
			return propPqty;
		}
		public void setPropPqty(String propPqty) {
			this.propPqty = propPqty;
		}
        ...
        public void setReviewQty(String reviewQty) {
