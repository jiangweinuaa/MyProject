...
public class DCP_FuncButtonUpdateReq extends JsonBasicReq {
	...
	public class levelElm{
		...
		private List<level1shopsElm> shops;
		...
		public List<level1shopsElm> getShops() {
			return shops;
		}

		public void setShops(List<level1shopsElm> shops) {
			this.shops = shops;
		}
