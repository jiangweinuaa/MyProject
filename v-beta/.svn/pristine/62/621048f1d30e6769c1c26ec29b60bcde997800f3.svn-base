...
public class DCP_PurStockOutUpdateReq extends JsonBasicReq {

    @Getter
    @Setter
    @JSONFieldRequired
    private DCP_PurStockOutUpdateReq.Request request;
    ...
    public class Request {
        ...
        private List<DCP_PurStockOutUpdateReq.Detail> dataList;
    }
    ...
    public class Detail {
        ...
        private List<DCP_PurStockOutUpdateReq.MulitiLosts> mulitiLotsList;
