...
public class OMSShipException extends InitJob
{
    //******兼容即时服务的,只查询指定的那张单据******
    String pEId="";
    String pShop="";
    ...
    Logger logger = LogManager.getLogger(OMSShipException.class.getName());

    static boolean bRun=false;//标记此服务是否正在执行中

    public OMSShipException()
    {

    }

    public OMSShipException(String eId,String shopId,String organizationNO, String billNo)
    {
        pEId=eId;
        pShop=shopId;
    ...
    public String doExe()  throws Exception
    {
        ...
        if (bRun && pEId.equals(""))
        {
            logger.info("\r\n*********获取分销OMS系统异常发货单OMSShipException正在执行中,本次调用取消:************\r\n");

            sReturnInfo="定时传输任务-取分销OMS系统异常发货单OMSShipException正在执行中！";
            return sReturnInfo;
        }
        ...
        {
            sReturnInfo="定时传输任务-取分销OMS系统异常发货单OMSShipException配置文件参数OMS_Url或OMS_Eid或OMS_ERP_Eid不能为空！";
            logger.error("\r\n*********"+sReturnInfo+"************\r\n");
            return sReturnInfo;
        }
        ...
        logger.info("\r\n*********取分销OMS系统异常发货单OMSShipException定时调用Start:************\r\n");
        ...
        try
        {
            ...
            Map<String, String> values=redis.getALLHashMap("OMS_Ship_Exception");
            ...
            while(it.hasNext())
            {
                ...
                requestparam.put("ebaent",jsonRedis.get("eid").toString());
                ...
                //更新重试次数
                redis.setHashMap("OMS_Ship_Exception",oms_eid+"_"+ebadocno,jsonRedis.toString());
                ...
                requestparam.put("ebadocno",ebadocno);
                ...
                logger.info("\r\n*********取分销OMS系统异常发货单OMSShipException定时调用请求:"+head.toString()+"************\r\n");
                ...
                {
                    logger.error("\r\n*********取分销OMS系统异常发货单OMSShipException 请求分销系统报错，返回为空************\r\n");
                }
                else
                {
...
//                                        }
                                        ...
                                        String b_unit=ebb_list.getJSONObject(i1).get("ebbtunit").toString();//交易单位
                                        ...
                                        InsBean ib_DCP_SALE_DETAIL = new InsBean("DCP_SALE_DETAIL", Columns_DCP_SALE_DETAIL);//分区字段处理
                                    ...
                                    if (eaiList != null && eaiList.length()>0 && a_ebastatus != null && !a_ebastatus.equals("S"))
                                    {
                                        ...
                                        logger.info("\r\n*********取分销OMS系统异常发货单OMSShipException定时调用请求:"+eai_head.toString()+"************\r\n");
                                        ...
                                        {
                                            logger.error("\r\n*********取分销OMS系统异常发货单OMSShipException "+a_billno+"过账操作请求分销系统报错，返回为空************\r\n");
                                            billToSale_ok=false;
                                            continue;
                                        }
                                        else
                                        {
                                            ...
                                            if (eai_resStatus.equals("200"))
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    logger.error("\r\n*********取分销OMS系统异常发货单OMSShipException "+a_billno+"过账操作请求分销系统报错，返回内容:"+Message+"************\r\n");
                                                    billToSale_ok=false;
                                                    continue;
                                                }
                                            }
                                            ...
                                            {
                                                logger.error("\r\n*********取分销OMS系统异常发货单OMSShipException "+a_billno+"过账操作请求分销系统报错，返回内容:"+resBody+"************\r\n");
                                                billToSale_ok=false;
                                                continue;
                                            }
                                        }
                                ...
                                catch (Exception e)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        logger.error("\r\n******取分销OMS系统异常发货单OMSShipException报错单号:"+a_billno + e.getMessage()+"\r\n" + errors.toString() + "******\r\n");
                                ...
                                finally
                                {
                                    ...
                                    if (billToSale_ok)
                                    {
                                        redis.DeleteHkey("OMS_Ship_Exception",oms_eid+"_"+a_billno);
                                    }
                                }
                            }
                            ...
                            if(datas.length()==0)
                            {
                                redis.DeleteHkey("OMS_Ship_Exception",oms_eid+"_"+ebadocno);
                            }
                        }
                        else
                        {
                            ...
                            logger.error("\r\n*********取分销OMS系统异常发货单OMSShipException 请求分销系统报错，返回为"+Message+"************\r\n");
                        }
                    }
                    else
                    {
                        logger.error("\r\n*********取分销OMS系统异常发货单OMSShipException 请求分销系统报错，返回为空"+resBody+"************\r\n");
                    }
                }
        ...
        catch (Exception e)
        {
            try
            {
                ...
                logger.error("\r\n******取分销OMS系统异常发货单OMSShipException报错信息" + e.getMessage()+"\r\n" + errors.toString() + "******\r\n");
        ...
        {
            bRun=false;//
            logger.info("\r\n*********取分销OMS系统异常发货单OMSShipException定时调用End:************\r\n");
        }
