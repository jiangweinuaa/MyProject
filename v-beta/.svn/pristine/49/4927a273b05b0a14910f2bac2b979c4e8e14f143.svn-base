...
public class DCP_ProcessPlanUpdateReq extends JsonBasicReq
{
    ...
    public class levelRequest
    {
        ...
        private  String pDateBegin;
        private  String pDateEnd;
        ...
        public void setWeekDay2(int weekDay2)
        {
            this.weekDay2 = weekDay2;
        }

        public int getWeekDay3()
        {
            return weekDay3;
        }

        public void setWeekDay3(int weekDay3)
        {
            this.weekDay3 = weekDay3;
        }

        public int getWeekDay4()
        {
            return weekDay4;
        }

        public void setWeekDay4(int weekDay4)
        {
            this.weekDay4 = weekDay4;
        }

        public int getWeekDay5()
        {
            return weekDay5;
        }

        public void setWeekDay5(int weekDay5)
        {
            this.weekDay5 = weekDay5;
        }

        public int getWeekDay6()
        {
            return weekDay6;
        }

        public void setWeekDay6(int weekDay6)
        {
            this.weekDay6 = weekDay6;
        }

        public int getWeekDay7()
        {
            return weekDay7;
        }

        public void setWeekDay7(int weekDay7)
        {
            this.weekDay7 = weekDay7;
        }

        public String getAutoCreateTask()
        {
            return autoCreateTask;
        }

        public void setAutoCreateTask(String autoCreateTask)
        {
