...
public class DCP_ReqCustomerCreateReq extends JsonBasicReq {
	...
	public String getStaffsQty() {
		return staffsQty;
	}
	public void setStaffsQty(String staffsQty) {
		this.staffsQty = staffsQty;
	}
	...
	public String getIsCretail() {
		return isCretail;
	}
	public void setIsCretail(String isCretail) {
		this.isCretail = isCretail;
	}
	public String getIsCorder() {
		return isCorder;
	}
	public void setIsCorder(String isCorder) {
		this.isCorder = isCorder;
	}
