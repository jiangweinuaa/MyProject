...
@Data
@NotThreadSafe
public class WxCpApacheHttpClientBuilder implements ApacheHttpClientBuilder {
...
/**
    ...
    private me.chanjar.weixin.common.util.http.apache.DefaultApacheHttpClientBuilder.IdleConnectionMonitorThread idleConnectionMonitorThread;
/**
    ...
    public WxCpApacheHttpClientBuilder() {
    }

    public static WxCpApacheHttpClientBuilder get() {
        return WxCpApacheHttpClientBuilder.SingletonHolder.INSTANCE;
    }
    ...
    public me.chanjar.weixin.common.util.http.apache.DefaultApacheHttpClientBuilder.IdleConnectionMonitorThread getIdleConnectionMonitorThread() {
    ...
    private synchronized void prepare() {
        ...
        this.idleConnectionMonitorThread = new me.chanjar.weixin.common.util.http.apache.DefaultApacheHttpClientBuilder.IdleConnectionMonitorThread(
    ...
    private SSLConnectionSocketFactory buildSSLConnectionSocketFactory() {
        try {
            ...
            SSLContext sslcontext = SSLContexts.custom().loadTrustMaterial(null, new org.apache.http.ssl.TrustStrategy() {
                @Override
...
/**
    ...
    private static class SingletonHolder {
        private static final WxCpApacheHttpClientBuilder INSTANCE = new WxCpApacheHttpClientBuilder();
    }
