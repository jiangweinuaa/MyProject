...
public class ConversationHistoryDTO implements Serializable {
    ...
    public static class DialogueDTO implements Serializable {
        ...
        private Object charts;          // 图表配置数组（解析后的 JSON 数组/对象，新格式）
        private Date createdTime;
        ...
        // charts 字段：返回解析后的数组对象（Jackson 会序列化为真正的 JSON 数组）
        public Object getCharts() { return charts; }
        public void setCharts(Object charts) { this.charts = charts; }
